...
<script type = "text/javascript">
	...
	/* Send Message	*/	
		...
		$('#send_msg').on('click', function(){
			if($('#msg').val() == ""){
				alert('Ilki bilen habaryňyz giriziň');
			}else{
				$msg = $('#msg').val();
				$id = $('#id').val();
				$.ajax({
